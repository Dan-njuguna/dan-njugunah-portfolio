    ...
    <section className="space-y-6">
      ...
      <div className="space-y-3">
        ...
        <p>
          ...
          receive through my website. My primary goal is to showcase my work
          and skills while respecting your privacy.
        </p>
        <H2>Information I Collect</H2>
        <p>
          As my website is a static portfolio, I do not actively collect
          personal data from visitors. No account creation is required, and I
        ...
        <p>
          ...
          page. I reserve the right to update or change my Privacy Policy at
          any time, and you should check this Privacy Policy periodically.
        </p>
        <H2>Contact Me</H2>
        <p>
          If you have any questions about this Privacy Policy, please contact me
          at njorogedan020j@gmail.com.
        </p>
      </div>
    </section>
  );
